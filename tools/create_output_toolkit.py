...
class CSVSaverTool(BaseTool):
    ...
    Output:
    - artefact_id: String ID of the stored CSV when the upload is successful, otherwise None.
    """
    ...
    def _run(self, dataframe: pd.DataFrame, description: Optional[str] = None) -> Optional[str]:
    ...
    async def _arun(self, dataframe: pd.DataFrame, description: Optional[str] = None) -> Optional[str]:
    ...
    def _handle_artefact_response(self, artefact_response: Dict[str, Any]) -> Optional[str]:
        ...
        if not artefact_id:
            logger.error("CSVSaverTool did not receive an artefact_id in response")
            return None
    ...
    def _render_review_levels(
        ...
        for key in ordered_keys:
            ...
            hoverlabel_cfg = {
                "font": {"color": "white"},
                "bordercolor": "white",
                "bgcolor": no_breach_color
            } if key == '__NO__' else None
