...
class TimezoneContext(BaseModel):
    """Timezone information for the app, sandbox, project and user."""
    app_timezone: Optional[str] = Field(description="App server timezone label and offset", default=None)
    user_timezone: Optional[str] = Field(description="User timezone label and offset", default=None)
    sandbox_timezone: Optional[str] = Field(description="Sandbox timezone label and offset", default=None)
    project_timezone: Optional[str] = Field(description="Project timezone label and offset", default=None)
    project_timezone_offset: Optional[str] = Field(description="Project timezone offset string e.g. '+08:00'", default=None)
    query_timezone_interpretation: Optional[str] = Field(description="How the query times have been interpreted with respect to user/project timezones", default=None)
...
class Context(BaseModel):
    ...
    timezone_context: Optional[TimezoneContext] = Field(description="Timezone context covering project, sandbox, app and user along with query interpretation", default=None)
...
class Execution(BaseModel):
    ...
    objective: str = Field(description="Objective generated by CodeAct coder for this execution", default="")
    plan: List[str] = Field(description="Plan steps generated by CodeAct coder for this execution", default_factory=list)
    ...
    artefacts: List[Dict[str, Any]] = Field(description="Plots and CSV files generated by tools initiated by the agent", default_factory=list)
